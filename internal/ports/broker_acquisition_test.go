...
func acquisitionTestPolicy() BrokerPolicy {
	return BrokerPolicy{ProtocolVersion: 58, CatalogSchemaVersion: 3, EnvironmentPolicy: protocol.EnvironmentPolicyDaemonOwned, Transport: "quic", Trust: "openssh", Launch: "explicit", Isolation: "user"}
}
