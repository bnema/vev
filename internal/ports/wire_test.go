...
func TestHelloGoldenAndRoundTrip(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: []byte{0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
		},
	}
...
func TestImagePushGoldenAndRoundTrip(t *testing.T) {
	tests := []struct {
		...
		{
			name: "png data",
			msg:  ImagePush{Mime: "image/png", Data: []byte{0x01, 0x02, 0x03}},
			want: []byte{0x00, 0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x2f, 0x70, 0x6e, 0x67, 0x01, 0x02, 0x03},
		},
		{name: "empty", msg: ImagePush{}, want: []byte{0x00, 0x00}},
	}
	...
	assertAllPrefixesFail(t, full[:11], UnmarshalImagePush)
}
