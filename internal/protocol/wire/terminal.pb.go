...
// TerminalFocus reports a focus change of the client's terminal window.
type TerminalFocus struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Closed focus taxonomy: 1 = focused, 2 = unfocused.
	Focus         uint32 `protobuf:"varint,1,opt,name=focus,proto3" json:"focus,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TerminalFocus) Reset() {
	*x = TerminalFocus{}
...
func (x *TerminalFocus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalFocus) ProtoMessage() {}

func (x *TerminalFocus) ProtoReflect() protoreflect.Message {
	mi := &file_terminal_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalFocus.ProtoReflect.Descriptor instead.
func (*TerminalFocus) Descriptor() ([]byte, []int) {
	return file_terminal_proto_rawDescGZIP(), []int{9}
}

func (x *TerminalFocus) GetFocus() uint32 {
	if x != nil {
		return x.Focus
	}
	return 0
...
const file_terminal_proto_rawDesc = "" +
	...
	"\rTerminalFocus\x12\x14\n" +
	"\x05focus\x18\x01 \x01(\rR\x05focus\"\"\n" +
	"\tSelectTab\x12\x15\n" +
...
var file_terminal_proto_goTypes = []any{
	...
	(*TerminalFocus)(nil),          // 9: vev.wire.v1.TerminalFocus
	(*SelectTab)(nil),              // 10: vev.wire.v1.SelectTab
	(*UIFence)(nil),                // 11: vev.wire.v1.UIFence
	(*UIReceipt)(nil),              // 12: vev.wire.v1.UIReceipt
	(*UIViewUpdate)(nil),           // 13: vev.wire.v1.UIViewUpdate
	(*RemotePreviewRequest)(nil),   // 14: vev.wire.v1.RemotePreviewRequest
	(*RemotePreviewWatch)(nil),     // 15: vev.wire.v1.RemotePreviewWatch
	(*RemotePreview)(nil),          // 16: vev.wire.v1.RemotePreview
...
var file_terminal_proto_depIdxs = []int32{
	...
	14, // 7: vev.wire.v1.RemotePreviewWatch.request:type_name -> vev.wire.v1.RemotePreviewRequest
	20, // 8: vev.wire.v1.RemotePreview.lifecycle_id:type_name -> vev.wire.v1.LifecycleID
	21, // 9: vev.wire.v1.RemotePreview.cells:type_name -> vev.wire.v1.PreviewCell
